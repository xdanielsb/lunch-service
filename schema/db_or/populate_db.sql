...
insert into puntaje_tipo_documento(id_puntaje_tipo_documento,nombre, id_tipo_documento, puntaje) values (4,'Carta al director mal escrita', 2,0);
...
--insert into estado_solicitud(id_estado_solicitud, estado, descripcion) values( 6, 'completada', '');
...
/**  Actividad **/
insert into actividad(id_actividad,nombre, horas_equivalentes) values (1,'Servicio social bienestar social', 2);
insert into actividad(id_actividad,nombre, horas_equivalentes) values (2,'Servicio social coordinación de ingeniería', 1);
insert into actividad(id_actividad,nombre, horas_equivalentes) values (3,'Servicio social decanatura', 3);
