...
drop sequence SEQ_CONVOCATORIA;
drop sequence SEQ_ESTADO_DOCUMENTO;
drop sequence SEQ_TIPO_DOCUMENTO;
drop sequence SEQ_PUNTAJE_TIPO_DOCUMENTO;
drop sequence SEQ_FACULTAD;
drop sequence SEQ_PROYECTO_CURRICULAR;
drop sequence SEQ_ESTUDIANTE;
drop sequence SEQ_ESTADO_SOLICITUD;
drop sequence SEQ_SOLICITUD;
drop sequence SEQ_HISTORICO_SOLICITUD;
drop sequence SEQ_DOCUMENTO_SOLICITUD;
drop sequence SEQ_TIPO_SUBSIDIO;
drop sequence SEQ_CONVOCATORIA_FACULTAD;
drop sequence SEQ_TIPO_SUBSIDIO_CONVOCATORIA;
drop sequence SEQ_BENEFICIARIO;
drop sequence SEQ_TICKET;
drop sequence SEQ_ESTADO_ACTIVIDAD;
drop sequence SEQ_ACTIVIDAD;
drop sequence SEQ_ACTIVIDAD_BENEFICIARIO;
